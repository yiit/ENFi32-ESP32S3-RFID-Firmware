...
//----------------------------------------------------------------------------
  ...
  public:
    ...
    inline void sleep(void) { _panel->setBrightness_lgfx(0); _panel->setSleep(true); }
    inline void wakeup(void) { _panel->setSleep(false); _panel->setBrightness_lgfx(_brightness); }
    ...
    inline void setBrightness_lgfx(uint8_t brightness) { _brightness = brightness; if (_panel) { _panel->setBrightness_lgfx(brightness); } }
