...
static void blend_mode_cb(lv_obj_t * parent)
{
    ...
    lv_color_format_t cf_values[] = {LV_COLOR_FORMAT_RGB565,
  .header.magic = LV_IMAGE_HEADER_MAGIC, LV_COLOR_FORMAT_RGB888, LV_COLOR_FORMAT_XRGB8888, LV_COLOR_FORMAT_ARGB8888};
