...
public:
  ...
  enum Enum : uint8_t {
    ...
    BOOT_CAUSE,
    BSSID,
    CARDID,       // RFID Card ID read by USB HID
    CARDTIMESTAMP, // RFID Card read timestamp
    CLIENTIP,
    CR,
    DNS,
    DNS_1,
    ...
    S_CR,
    RSSI,
    SERVERSTATUS, // PDKS API Server connection status
    SPACE,
    SSID,
    SUBNET,
    SUNRISE,
  ...
  // RFID Card ID management
  static String                     getCardID();
  static void                      setCardID(const String& cardid);
  
  // RFID Card Timestamp management
  static String                     getCardTimestamp();
  static void                      setCardTimestamp(const String& timestamp);

  // Server connection status management
